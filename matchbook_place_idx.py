...
while True:
  ...
  try:
    ...
    for t in r.json()['hits']['hits']:
      ...
      if cur_ts<=tmp['timestamp']/1000 and tmp['timestamp']/1000 not in total_dat and tmp['timestamp']/1000 in new_race_list:
        print "New Race......................."
        matchbook_login()
        model_1(tmp)
